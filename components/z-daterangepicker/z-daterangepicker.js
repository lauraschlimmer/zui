...
var DateRangePickerComponent = function() {
  this.createdCallback = function() {
    ...
    //prevent select event from bubbling
    this.querySelector("input.from").addEventListener("select", function(e) {
      e.stopPropagation();
    }, false);

    this.querySelector("input.until").addEventListener("select", function(e) {
      e.stopPropagation();
    }, false);
